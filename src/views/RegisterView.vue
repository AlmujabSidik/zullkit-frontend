...
import FeatureRegister from "@/components/authentication/FeatureRegister.vue";
</script>
...
<template>
  <main>
    <div class="relative overflow-hidden bg-white">
      <div class="mx-auto">
        <div class="flex flex-col items-center w-full lg:pt-24 sm:justify-center sm:pt-0">
